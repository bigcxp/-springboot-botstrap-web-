        ...
        requirejs(
            ...
            function ($) {
                ...
                $('#tb_company').bootstrapTable({
                    ...
                    classes: "table table-bordered table-sm table-hover",//启用bootstrap的表格样式
                    ...
                    columns: [{
                        ...
                        formatter: function indexFormatter(value, row, index) {
                            var newvalue = "";
                            if (value == 0) {
                                newvalue = '<span class="badge badge-danger">' + "已经注销" + '</span>';

                            }
                            else if (value == 1) {
                                newvalue = '<span class="badge badge-warning">' + "正在注销" + '</span>';
                            }
                            else {
                                newvalue = '<span class="badge badge-success">' + "正常运营" + '</span>';
                            }
                            return newvalue;
                        }
                    }, {
